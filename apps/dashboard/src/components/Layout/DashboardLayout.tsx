...
const navigation = [
  ...
  { name: 'Menu Items', href: '/dashboard/menu', icon: ClipboardDocumentListIcon },
  { name: 'Users', href: '/dashboard/users', icon: UsersIcon },
  { name: 'Contact', href: '/dashboard/contact', icon: ChatBubbleLeftRightIcon },
];
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Sundate Admin</span>
            </div>
          ...
          <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
            ...
            <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
              <div className="flex items-center w-full">
                ...
                <button
                  onClick={logout}
                  className="ml-2 p-1 rounded-md text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-green-500"
                  title="Logout"
                >
