...
const validateProfileUpdate = [
  ...
  body('preferences.dietaryRestrictions').optional().isArray().withMessage('Dietary restrictions must be an array'),
...
// GET /api/auth/users-test - Get all users WITHOUT authentication (FOR TESTING ONLY - DISABLE IN PRODUCTION)
